...
export const en: Translations = {
  ...
  home: {
    ...
    arrivalNote: 'Please arrive by 3:30 PM to allow time for parking and seating before the 4:00 PM ceremony.',
    appleMapsNote: 'Apple Maps works best.',
    openInMaps: 'Open in Maps',
    brunchDateTime: 'Sunday, October 25 · 10 AM – 1 PM',
    rsvpText: 'Please RSVP as soon as possible using the Google form you received along with your invitation.',
    rsvpDeadline: 'Hard deadline: September 15.',
